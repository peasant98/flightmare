...
class QuadrotorGoalConditionedEnv final : public EnvBase {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  QuadrotorGoalConditionedEnv();
  QuadrotorGoalConditionedEnv(const std::string &cfg_path);
  ~QuadrotorGoalConditionedEnv();
  ...
  friend std::ostream &operator<<(std::ostream &os,
                                  const QuadrotorGoalConditionedEnv &quad_env);
 ...
 private:
  ...
  Command cmd_;
  Logger logger_{"QaudrotorGoalConditionedEnv"};
